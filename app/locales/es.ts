...
const es: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    TopTips:
      "🥳 Oferta de lanzamiento de Sheep Interview AI, desbloquea OpenAI o1, GPT-4o, Claude-3.5 y los últimos grandes modelos",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    InjectSystemPrompts: {
      ...
      SubTitle:
        "Forzar la adición de un mensaje del sistema simulado de Sheep Interview AI al principio de cada lista de mensajes",
    },
    InputTemplate: {
    ...
    Access: {
      SaasStart: {
        Title: "Use Sheep Interview AI",
        Label: "(The most cost-effective solution)",
        SubTitle:
          "Officially maintained by Sheep Interview, zero configuration ready to use, supports the latest large models like OpenAI o1, GPT-4o, and Claude-3.5",
        ChatNow: "Chat Now",
      },
